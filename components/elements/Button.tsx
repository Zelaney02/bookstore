const getVariant = (variant?: VariantType) => {
  switch (variant) {
    case 'primary':
      return 'bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold shadow shadow-primary-600/25 hover:shadow-primary-600/75';
    case 'danger':
    ...
    case 'outline-primary':
      return 'bg-white text-primary-500 border border-primary-500 hover:text-white hover:bg-primary-700  ';

    default:
      return 'bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold shadow shadow-primary-600/25 hover:shadow-gray-600/75';
  }
};
